...
?>
        <div class="flex items-center w-full p-4 mb-4 text-sm text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800" role="alert">
            ...
            <div>
                <span class="font-medium">Error!</span> Password incorrect, please try again.
            </div>
        </div>
<?php } elseif ($_GET['status'] == 'exist') { ?>
        ...
        <span class="sr-only">Info</span>
        <div>
            <span class="font-medium">Error!</span> Account doesn't exist, please try again.
        </div>
        </div>
...
<?php } } ?>
                    <form class="space-y-4 md:space-y-6" action="async/login.php" method="POST">
                        <div>
