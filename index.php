    ...
    <div class="pb-8 sm:pb-12 lg:pb-12">
        <div class="pt-8 overflow-hidden sm:pt-12 lg:relative lg:py-48">
          <div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl lg:grid lg:grid-cols-2 lg:gap-24">
            <div>
              <div>
                <img class="h-11 w-auto" src="assets/img/logo.png" alt="Sport Track">
              </div>
              <div class="mt-20">
                <div>
                  <a href="#" class="inline-flex space-x-4">
                    <span class="rounded bg-gray-50 px-2.5 py-1 text-xs font-semibold text-indigo-600 tracking-wide uppercase"> What's new </span>
                ...
                <div class="mt-6 sm:max-w-xl">
                  <h1 class="text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">Welcome to Sport Track</h1>
          ...
          <div class="sm:mx-auto sm:max-w-3xl sm:px-6">
            <div class="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
              <div class="hidden sm:block">
                <div class="absolute inset-y-0 left-1/2 w-screen bg-gradient-to-tl from-[#77c2f7] to-[#64f5b4] rounded-l-3xl lg:left-80 lg:right-0 lg:w-full"></div>
              ...
              <div class="relative pl-4 -mr-40 sm:mx-auto sm:max-w-3xl sm:px-0 lg:max-w-none lg:h-full lg:pl-12">
                <img class="w-full rounded-md shadow-xl ring-1 ring-black ring-opacity-5 lg:h-full lg:w-auto lg:max-w-none" src="assets/img/hero_image_running.webp" alt="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container px-5 py-24 mx-auto">
          <div class="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            ...
            <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              <h2 class="text-gray-900 text-lg title-font font-medium mb-2">Sync your data with all your devices</h2>
            </div>
          </div>
          <div class="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              <h2 class="text-gray-900 text-lg title-font font-medium mb-2">Track your running data</h2>
            </div>
          ...
          <div class="flex items-center lg:w-3/5 mx-auto sm:flex-row flex-col">
            ...
            <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              <h2 class="text-gray-900 text-lg title-font font-medium mb-2">Your data is kept securely</h2>
            </div>
          </div>
        </div>
      </section>
    ...
    <div class="lg:w-4/6 mx-auto">
      ...
      <div class="flex flex-col sm:flex-row mt-10">
        <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
          <img class="w-20 h-20 rounded-full inline-flex items-center justify-center" src="assets/img/miaou.png">
          <div class="flex flex-col items-center text-center justify-center">
            <h2 class="font-medium title-font mt-4 text-gray-900 text-lg">Merlin Caromel & Amélie Anneix</h2>
            <div class="w-12 h-1 bg-indigo-500 rounded mt-2 mb-4"></div>
            <p class="text-base">Hi everyone! We are french students from the Britanny South University.</p>
          </div>
        </div>
        <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
          <p class="leading-relaxed text-lg mb-4">We developped this website in order to help users to track their fitness performances. You can freely create an account and specify all your sports habits and data so you can better understand your needs. This way, you can better organise your sport session, fix your goals and improve your abilities.</p>
        </div>
      </div>
    </div>
  </div>
